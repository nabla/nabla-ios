...
extension GQL {
  class GetFinalizedAppointmentsLocalCacheMutation: LocalCacheMutation {
    ...
    struct Data: GQL.MutableSelectionSet {
      ...
      var pastAppointments: PastAppointments {
        get { __data["pastAppointments"] }
        set { __data["pastAppointments"] = newValue }
      }

      /// PastAppointments
      ///
      /// Parent Type: `AppointmentsPage`
      struct PastAppointments: GQL.MutableSelectionSet {
        var __data: DataDict
        init(data: DataDict) { __data = data }
