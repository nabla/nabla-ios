  ...
  class AppointmentsEventsSubscription: GraphQLSubscription {
    ...
    struct Data: GQL.SelectionSet {
      ...
      struct Appointments: GQL.SelectionSet {
        ...
        static var __parentType: ApolloAPI.ParentType { GQL.Objects.AppointmentsEventOutput }
        static var __selections: [ApolloAPI.Selection] { [
        ...
        struct Event: GQL.SelectionSet {
          ...
          static var __parentType: ApolloAPI.ParentType { GQL.Unions.AppointmentsEvent }
          static var __selections: [ApolloAPI.Selection] { [
          ...
          struct AsAppointmentCreatedEvent: GQL.InlineFragment {
            ...
            static var __parentType: ApolloAPI.ParentType { GQL.Objects.AppointmentCreatedEvent }
            static var __selections: [ApolloAPI.Selection] { [
          ...
          struct AsAppointmentUpdatedEvent: GQL.InlineFragment {
            ...
            static var __parentType: ApolloAPI.ParentType { GQL.Objects.AppointmentUpdatedEvent }
            static var __selections: [ApolloAPI.Selection] { [
              .field("appointment", Appointment.self),
            ] }
          ...
          struct AsAppointmentCancelledEvent: GQL.InlineFragment {
            ...
            static var __parentType: ApolloAPI.ParentType { GQL.Objects.AppointmentCancelledEvent }
            static var __selections: [ApolloAPI.Selection] { [
