 ...
 extension GQL {
  struct ConversationFragment: GraphQLFragment {
    /// The raw GraphQL definition of this fragment.
     ...
     init(id: GQL.UUID, title: String? = nil, subtitle: String? = nil, lastMessagePreview: String? = nil, lastMessage: LastMessage? = nil, unreadMessageCount: Int, inboxPreviewTitle: String, updatedAt: GQL.DateTime, pictureUrl: PictureUrl? = nil, providers: [Provider], isLocked: Bool) {
      self.init(unsafeResultMap: ["__typename": "Conversation", "id": id, "title": title, "subtitle": subtitle, "lastMessagePreview": lastMessagePreview, "lastMessage": lastMessage.flatMap { (value: LastMessage) -> ResultMap in value.resultMap }, "unreadMessageCount": unreadMessageCount, "inboxPreviewTitle": inboxPreviewTitle, "updatedAt": updatedAt, "pictureUrl": pictureUrl.flatMap { (value: PictureUrl) -> ResultMap in value.resultMap }, "providers": providers.map { (value: Provider) -> ResultMap in value.resultMap }, "isLocked": isLocked])
    }
     ...
     struct LastMessage: GraphQLSelectionSet {
