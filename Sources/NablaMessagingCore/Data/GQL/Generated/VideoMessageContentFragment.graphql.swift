...
public extension GQL {
  struct VideoMessageContentFragment: GraphQLFragment {
    ...
    public init(videoFileUpload: VideoFileUpload) {
    ...
    public var videoFileUpload: VideoFileUpload {
      get {
    ...
    public struct VideoFileUpload: GraphQLSelectionSet {
      public static let possibleTypes: [String] = ["VideoFileUpload"]
