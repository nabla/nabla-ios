    ...
    final class ConversationEventsSubscription: GraphQLSubscription {
        ...
        public struct Data: GraphQLSelectionSet {
            ...
            public var conversation: Conversation? {
                get {
                    (resultMap["conversation"] as? ResultMap).flatMap { Conversation(unsafeResultMap: $0) }
                }
                set {
            ...
            public struct Conversation: GraphQLSelectionSet {
                ...
                public var event: Event {
                    get {
                        Event(unsafeResultMap: resultMap["event"]! as! ResultMap)
                    }
                    set {
                ...
                public struct Event: GraphQLSelectionSet {
                    ...
                    public static func makeConversationActivityCreated() -> Event {
                        Event(unsafeResultMap: ["__typename": "ConversationActivityCreated"])
                    }

                    public static func makeSubscriptionReadinessEvent(isReady: Bool) -> Event {
                        Event(unsafeResultMap: ["__typename": "SubscriptionReadinessEvent", "isReady": isReady])
                    }

                    public static func makeMessageCreatedEvent(message: AsMessageCreatedEvent.Message) -> Event {
                        Event(unsafeResultMap: ["__typename": "MessageCreatedEvent", "message": message.resultMap])
                    }

                    public static func makeMessageUpdatedEvent(message: AsMessageUpdatedEvent.Message) -> Event {
                        Event(unsafeResultMap: ["__typename": "MessageUpdatedEvent", "message": message.resultMap])
                    }

                    public static func makeTypingEvent(provider: AsTypingEvent.Provider) -> Event {
                        Event(unsafeResultMap: ["__typename": "TypingEvent", "provider": provider.resultMap])
                    }
                    ...
                    public struct AsMessageCreatedEvent: GraphQLSelectionSet {
                        ...
                        public var message: Message {
                            get {
                                Message(unsafeResultMap: resultMap["message"]! as! ResultMap)
                            }
                            set {
                    ...
                    public struct AsTypingEvent: GraphQLSelectionSet {
                        ...
                        public var provider: Provider {
                            get {
                                Provider(unsafeResultMap: resultMap["provider"]! as! ResultMap)
                            }
                            set {
